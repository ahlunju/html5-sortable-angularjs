...
sortable_app.directive('htmlSortable', function($parse,$timeout, $log, $window) {
  ...
  DragDrop.prototype = {
    ...
    move: function(event) {
      ...
      // this.el.style["pointer-events"] = "none"; //Yalun
      this.el.style["z-index"] = "999999"; //Yalun
  ...
  return {
    ...
    link: function(scope, element, attrs,ngModel) {
      ...
      sortable.touchhandle = function(e){
        ...
        sortable.is_handle = true;
        new DragDrop(e, el.parentNode.parentNode.parentNode.parentNode); //el is then handle, 4th parent is the excerpt
      }
